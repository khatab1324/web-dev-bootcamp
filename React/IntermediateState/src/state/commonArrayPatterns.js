...
//   https://react.dev/learn/updating-arrays-in-state they have good docs
shoppingCart.map((item) => {
  return {
    ...item,
    product: item.product.toLowerCase(), //this will take product from every item and pass this update
  };
});
